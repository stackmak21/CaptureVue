...
class NetworkClient: NSObject {
    ...
    func upload(
        ...
        do{
            ...
            self.uploadFinished = uploadCompleted
...
extension NetworkClient: URLSessionTaskDelegate {
    ...
    func urlSession(
        ...
        totalBytesExpectedToSend: Int64) {
            ...
            if Int(Float(totalBytesSent) / Float(totalBytesExpectedToSend) * 100) > 99  {
                uploadFinished?()
            }
